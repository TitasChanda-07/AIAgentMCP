...
AIAgentMCP is a learning / reference project that demonstrates building, configuring, and running AI-powered agents for software testing and automation. The project follows concepts and exercises from the Udemy course "Learn AI Tools & Build AI Agents for Software Testing" and contains example agents, orchestration utilities, and integration patterns for using large language models and automated test workflows. This repository is intended for:
